...
const incidents = [
  { lat: 49.7439, lng: 15.3381, icon: icons.droneYellow, type: 'drone', risk: 'yellow', location: 'others', date: '2025-09-10', details: "Czech army reported drone sightings.", link:"https://www.reuters.com/...", country:"Czech Republic 🇨🇿" },
  { lat: 40.7128, lng: -74.0060, icon: icons.jetRed, type: 'jet', risk: 'red', location: 'others', date:'2025-10-12', details:"Jet intercepted over US airspace.", link:"https://www.example.com", country:"USA 🇺🇸" },
  { lat: 35.6895, lng: 139.6917, icon: icons.balloonBlue, type:'balloon', risk:'blue', location:'others', date:'2025-11-05', details:"Balloon spotted over Japan.", link:"https://www.example.com", country:"Japan 🇯🇵" },
  { lat: 51.4700, lng: -0.4543, icon: icons.airportGreen, type:'airport', risk:'green', location:'airports', date:'2025-10-01', details:"London Heathrow Airport.", link:"https://www.example.com", country:"UK 🇬🇧" }
];
...
function applyFilters() {
  ...
  markers.forEach(m => {
    ...
    const typeMatch =
      ...
      (type === 'militarybases' && showMilitary) ||
      (type === 'others' && showOthers);
